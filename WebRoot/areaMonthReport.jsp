...
<!-- END HEAD -->
<!-- BEGIN BODY -->
<body class="page-header-fixed" onload="menuSelect(5, 2, 2); notification()">
	...
	<%@include file="sidebar.jsp" %>
		...
		<div class="page-content">
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						<form class="form-inline" action="reportAction_areaMonthReport">
						...
						<div class="portlet box grey">
							...
							<div class="portlet-body">
								<table class="table table-bordered table-hover">
									<thead>
									    <tr>
									        <th colspan="16">${year}年度区域温度月报表（${areaName}）</th>
									    </tr>
										<tr>
									...
									<tbody>
									<s:iterator value="%{reportMonthAreas}" id="report">
										<tr>
