...
<!-- END HEAD -->
<!-- BEGIN BODY -->
<body class="page-header-fixed" onload="menuSelect(5, 2, 1); notification()">
	...
	<%@include file="sidebar.jsp" %>
		...
		<div class="page-content">
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						<form id="reportForm" class="form-inline" action="reportAction_nodeMonthReport">
							...
							<div class="input-append date" id="startDate"
								...
								<input size="16" type="text" readonly
									style="width:160px;height:28px;" id="monthDate" name="year" value="${year}">
						...
						<div class="portlet box grey">
							...
							<div class="portlet-body">
								<table class="table table-bordered table-hover">
									<thead>
									    <tr>
									        <th colspan="16">${year}年度节点温度月报表（${nodeNo}）</th>
									    </tr>
										<tr>
									...
									<tbody>
									<s:iterator value="%{reportMonthNodes}" id="report">
										<tr>
											<td>${report.monthOfYear}</td>
...
<%-- 								<div class="row-fluid">
   ...
   <%@include file="footer.jsp" %>
	...
	function formCheck(){
		if($("#nodeName_s").val() != '-1' && $("#monthDate").val() != ''){
			return true;
		}else{
			alert('请正确选择节点和年份!');
			return false;
