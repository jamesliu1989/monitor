...
public class ReportMonthNode implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5375150875985768960L;
	private Integer id;
	...
	/** default constructor */
	public ReportMonthNode() {
	}

	/** minimal constructor */
	public ReportMonthNode(String nodeNo, String monthYear) {
		this.nodeNo = nodeNo;
		this.monthOfYear = monthYear;
	}

	/** full constructor */
	public ReportMonthNode(String nodeNo, Double tempMedMax, Double tempMedMin,
