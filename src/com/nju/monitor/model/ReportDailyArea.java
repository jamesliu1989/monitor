...
public class ReportDailyArea implements java.io.Serializable {
     ...
     * default constructor
     */
    public ReportDailyArea() {
    }

    /**
     * minimal constructor
     */
    public ReportDailyArea(String areaNo, String dayOfYear, String monthYear) {
        this.areaNo = areaNo;
        this.dayOfYear = dayOfYear;
        this.monthOfYear = monthYear;
    }

    public ReportDailyArea(Integer id, String areaNo, Double tempMedMax, Double tempMedMin, Double tempMedAvg, Double tempEnvMax, Double tempEnvMin, Double tempEnvAvg, Double tempDevAbs, Double humidityMax, Double humidityMin, Double humidityAvg, Integer smogAlert, Double batteryVol, Integer wirelessSig, Integer status, Integer alert, String dayOfYear, String monthOfYear) {
        this.id = id;
        this.areaNo = areaNo;
