...
public class AreaService 
{
	...
	public List<Object> areasView(int ctrlerNo) {
		...
		for(Object[] area : areaList){
			...
			double tempMedAvg = ((tempMedSum==0) ? 0.0 : tempMedSum/count);
			...
			double deltaMedAvg = ((deltaMedSum==0) ? 0.0 : deltaMedSum/count);
			...
			double tempEnvAvg = ((tempEnvSum==0) ? 0.0 : tempEnvSum/count);
			...
			double deltaEnvAvg = ((deltaEnvSum==0) ? 0.0 : deltaEnvSum/count);
			...
			double humidityAvg = ((humiditySum==0) ? 0.0 : humiditySum/count);
